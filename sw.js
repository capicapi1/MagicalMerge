const CACHE = "mahoumerge-v8";
const ASSETS = ["./","./index.html","./styles.css","./game.js","./manifest.json","./icon.svg",
"./assets/girl_1.png","./assets/girl_2.png","./assets/girl_3.png",
"./assets/enemy_1.png","./assets/enemy_2.png","./assets/enemy_3.png","./assets/enemy_4.png","./assets/enemy_5.png","./assets/enemy_6.png","./assets/enemy_7.png"];
